...
class Firework:
    ...
    def move(self, max_width, max_height):
        ...
        for proj in self.projectiles:   # change variable name here
            proj.move()

            if proj.x >= max_width or proj.x < 0:
                projectiles_to_remove.append(proj)
            elif proj.y >= max_height or proj.y < 0:
                projectiles_to_remove.append(proj)

        for proj in projectiles_to_remove:  # change variable name here
